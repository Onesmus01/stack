  ...
  useEffect(() => {
    const fetchProductData = () => {
      ...
      if (product) {
        ...
        setImage(product.image && Array.isArray(product.image) ? product.image[0] : ''); // Default to first image or handle no image
      }
    };
    fetchProductData();
  }, [productId, products]);
    ...
    <div className='border-t-2 pt-1 transition-opacity ease-in duration-500 opacity-100'>
      <div className="flex gap-12 sm:gap-0 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-row items-center gap-1 mt-2">
            {/* Assuming assets are correctly imported */}
            <img src={''} alt="star" className='w-3.5' />
            <img src={''} alt="star" className='w-3.5' />
            <img src={''} alt="star" className='w-3.5' />
            <img src={''} alt="star" className='w-3.5' />
            <img src={''} alt="star" className='w-3.5' />
      ...
      <div className="mt-top">
        ...
        <div className="flex flex-col gap-4 border px-6 text-sm text-gray-500">
          <p>An e-commerce website is an online platform that facilitates selling and buying of Lorem ipsum dolor sit amet, consectetur adipisicing elit...</p>
        </div>
      </div>
