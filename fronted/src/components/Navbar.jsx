    ...
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="group relative">
          <BiUser onClick={()=> token ? null : navigate('/login')} className='w-5 cursor-pointer' />
             {/* drop down  */}
             {token && <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4 transition-all ease-in-out duration-200">
